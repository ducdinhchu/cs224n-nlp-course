...
\begin{parts}
    ...
    \ifans{
        We remove $n$ words from the buffer and push them onto the stack in $n$ steps (one at a time), and we pop them off the
        stack also in $n$ steps (also one at a time). So, a sentence containing $n$ words will be parsed in $2n$ steps.
    }\newline
...
%\State
    ...
    \ifans{
        Best dev UAS: 88.88 \> test UAS: 88.77
    } \newline
...
%\medskip
    ...
    i.
        \begin{itemize}
            ...
            \item \textbf{Incorrect dependency}: looks $\rightarrow$ mind
            \item \textbf{Correct dependency}: eyes $\rightarrow$ mind
        \end{itemize}
        ii.
        \begin{itemize}
            \item \textbf{Error type}: Prepositional Phrase Attachment Error
            \item \textbf{Incorrect dependency}: chasing $\rightarrow$ fur
            \item \textbf{Correct dependency}: dogs $\rightarrow$ fur
        \end{itemize}
        iii.
        \begin{itemize}
